...
class RandAugmentPolicy(object):
    ...
    def __init__(self, fillcolor=(0,0,0), N=1, M=5, max_param=10):
        self.policies = ["invert","autocontrast","equalize", "solarize","color", \
    ...
    def __call__(self, img):
        ...
        for policy in choosen_policies:
            subpolicy_obj = SubPolicy(operation=policy, magnitude=self.M, MAX_PARAM=self.max_param)
