...
class Wheat(BaseDataLoader):
    def __init__(self, data_dir, batch_size, split, crop_size=None, base_size=None, scale=True, num_workers=1, val=False,
                    ...
                    create_dataset_using_txt=False, load_from=None, crop_h=None, crop_w=None):
        ...
        self.dataset = WheatDataset(create_dataset_using_txt=create_dataset_using_txt, load_from=load_from, **kwargs)
