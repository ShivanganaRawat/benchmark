...
class AppleDataset(BaseDataSet):
    ...
    """
    def __init__(self, create_dataset_using_txt=False, load_from=None, num_policies=None, magnitude=None, max_param=None, randaug=True, **kwargs):
        self.num_classes = 2
    ...
    def rand_aug(self, image):
        random_augmentation = RandAugmentPolicy(N = self.num_policies , M = self.magnitude, max_param = self.max_param)
...
class Apple(BaseDataLoader):
    def __init__(self, data_dir, batch_size, split, crop_size=None, base_size=None, scale=True, num_workers=1, val=False,
                    ...
                    create_dataset_using_txt=False, load_from=None, crop_h=None, crop_w=None, num_policies=None, magnitude=None, max_param=None, randaug=True):
        ...
        self.dataset = AppleDataset(create_dataset_using_txt=create_dataset_using_txt, load_from=load_from, 
                                    num_policies=num_policies, magnitude=magnitude, max_param=max_param, randaug=randaug, **kwargs)
