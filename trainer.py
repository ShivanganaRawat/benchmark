...
class Trainer(BaseTrainer):
    ...
    def _train_epoch(self, epoch):
        ...
        log = {'loss': self.total_loss.average,
                **seg_metrics}
        #wandb.log({'train_total_loss': log['loss'], 'epoch':epoch})
    ...
    def _valid_epoch(self, epoch):
        ...
        with torch.no_grad():
            ...
            #wandb.log({'val_total_loss': log['val_loss'], 'epoch':epoch})
    ...
    def _test_epoch(self, epoch):
        ...
        with torch.no_grad():
            ...
            #wandb.log({'test_total_loss': log['test_loss'], 'epoch':epoch})
    ...
    def _get_seg_metrics(self):
        ...
        IoU = 1.0 * self.total_inter / (np.spacing(1) + self.total_union)# + self.total_inter)
        mIoU = IoU.mean()
        return {
